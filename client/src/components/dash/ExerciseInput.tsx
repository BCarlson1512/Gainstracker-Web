    ...
    return ( 
        <div className="flex flex-col p-2 m-2 card-general">
            ...
            <div className="flex flex-row justify-between p-1 m-1">
                ...
                <input className="m-1 text-slate-600 rounded-md border-2 border-slate-600" value={data ? data.name : ""} onChange={(e) => handleChange(id, e.target.value, null)} />
            </div>
            <div className="flex flex-row justify-between p-1 m-1">
                <label className="m-1 text-slate-600">Muscle Group:</label>
                <input className="m-1 text-slate-600 rounded-md border-2 border-slate-600" value={data ? data.muscleGrouping : ""} onChange={(e) => handleChange(id, null, e.target.value)} />
            </div>
